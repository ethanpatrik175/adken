            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="text-center">
                            <p>Remember It ? <a href="{{route('admin.login')}}" class="font-weight-medium text-primary"><i class="mdi mdi-key"></i> Login here</a> OR <a href="{{route('front.index')}}" class="font-weight-medium text-primary">HOME</a> </p>
