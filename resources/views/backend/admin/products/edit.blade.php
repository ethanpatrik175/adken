    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form class="needs-validation" method="POST" action="{{ route('admin.products.update', $product->id) }}" enctype="multipart/form-data" novalidate>
                    <div class="row">
                        @csrf
                        @method('PUT')
                        <div class="col-sm-9">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="name" id="name"
                                                    placeholder="Name here" value="{{ $product->name ?? '' }}" required>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea rows="4" class="form-control" name="description" id="description" placeholder="Description here">{{ $product->description ?? '' }}</textarea>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control text-start"
                                                    value="{{ $product->sku ?? '' }}" name="sku" placeholder="Product SKU" id="sku" required>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control input-mask text-start"
                                                    value="{{ $product->retail_price ?? 0 }}" name="retail_price"
                                                    id="retail_price"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control input-mask text-start"
                                                    value="{{ $product->sale_price ?? 0 }}" name="sale_price" id="sale_price"
                                                    data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'digits': 2, 'digitsOptional': false, 'placeholder': '0'">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control input-mask text-start"
                                                    value="{{ $product->shipping_charges ?? 0 }}" name="shipping_charges" id="shipping_charges"
                                                    data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'digits': 2, 'digitsOptional': false, 'placeholder': '0'">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control input-mask text-start"
                                                    value="{{ $product->quantity ?? 0 }}" name="quantity" id="quantity" required
                                                    data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'digits': 2, 'digitsOptional': false, 'placeholder': '0'">
                                                <div class="invalid-feedback">
                                        ...
                                        {{-- <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control input-mask text-start"
                                                    value="{{ $product->stock_alert_quantity ?? 0 }}" name="stock_alert_quantity" id="stock_alert_quantity"
                                                    data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'digits': 2, 'digitsOptional': false, 'placeholder': '0'">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control input-mask text-start"
                                                    value="{{ $product->type ?? '' }}" name="packing_type" id="packing_type" placeholder="Jar / Bottle / Packet" required/>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <select name="is_sample" id="is_sample" class="form-select">
                                                    ...
                                                    <option value="yes" {{ ($product->is_sample == 1) ? 'selected' : ''  }}>Yes</option>
                                                    <option value="no" {{ ($product->is_sample == 0) ? 'selected' : ''  }}>No</option>
                                                </select>
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            <div class="form-group">
                                                ...
                                                <img src="{{ asset('assets/frontend/images/products/' . $product->image) }}"
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            <div class="form-group">
                                                <label class="control-label">Current Summary Image</label>
                                                <img src="{{ asset('assets/frontend/images/products/' . $product->summary_image) }}"
                                                    class="form-control img-thumbnail" alt="">
                                            </div>
                                        </div>
                                    </div>
